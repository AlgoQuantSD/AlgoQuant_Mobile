    ...
    <View>
      ...
      <View>
        <View style={styles.analysisRow}>
          ...
          <Text>{backtest.backtestName}</Text>
        </View>
        <View style={styles.analysisRow}>
          <Text>Start date: </Text>
          <Text>{backtest.startDate}</Text>
        </View>
        <View style={styles.analysisRow}>
          <Text>End date: </Text>
          <Text>{backtest.endDate}</Text>
        </View>
        <View style={styles.analysisRow}>
          <Text>Initial investment: </Text>
          <Text>${backtest.initialInvestment}</Text>
        </View>
        <View style={styles.analysisRow}>
          <Text>Final balance: </Text>
          <Text>${backtest.finalBalance}</Text>
        </View>
        <View style={styles.analysisRow}>
